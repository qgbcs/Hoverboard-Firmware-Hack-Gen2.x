...
*/
// Hall sensor defines CORRECT
#define HALL_A_PIN GPIO_PIN_13	// robo
#define HALL_A_PORT GPIOA
#define HALL_C_PIN GPIO_PIN_5		// robo
#define HALL_C_PORT GPIOA				// robo
#define HALL_B_PIN GPIO_PIN_0		// robo
#define HALL_B_PORT GPIOB				// robo
