...
- as only UART control is supported you can download compiled binaries [ready](HoverBoardGigaDevice/BinariesToFlash/) or there: [pionierland.de/hoverhack/gen2/ReadyToFlash](https://pionierland.de/hoverhack/gen2/ReadyToFlash/) (the test-firmwares will ignore uart speed and will repeat speed from -300 to 300 instead)
- Binaries not yet working: [test](HoverBoardGigaDevice/BinariesToTest/)
