...
- as only UART control is supported you can download compiled binaries here: https://github.com/RoboDurden/Hoverboard-Firmware-Hack-Gen2.x/tree/main/HoverBoardGigaDevice/ReadyToFlash (the test.bin  will ignore uart speed and will repeat speed from -300 to 300 instead)
